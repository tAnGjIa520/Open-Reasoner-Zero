...
class PPOExpConfig(BasePPOExpConfig):
    ...
    ckpt_path: str = f"jericho/orz_ckpt_1gpu/{file_name}"
    save_path: str = f"jericho/orz_ckpt_1gpu/{file_name}"
    tensorboard_log_dir: str = f"jericho/orz_logs_1gpu/{file_name}"
