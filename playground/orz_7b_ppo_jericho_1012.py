...
class PPOExpConfig(BasePPOExpConfig):
    ...
    ckpt_path: str = f"orz_jericho_20251012_ckpt/{file_name}"
    save_path: str = f"orz_jericho_20251012_ckpt/{file_name}"
    tensorboard_log_dir: str = f"orz_jericho_20251012_logs/{file_name}"
    ...
    gpu_memory_utilization: float = 0.4 # TODO： 测试无oom
